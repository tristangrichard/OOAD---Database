	...
	<div class="container">
		<div class="row">
			<div class="span13">
						...
						<tr>
							...
							<td><select name="newPub" required>
									...
									<option value=<%=p.getPid()%>
										<%if (userPub.getPid() == p.getPid()) {
					out.print("selected");
				}%>><%=p.getPublisher()%></option>
									<%
										}
									%>
							</select></td>
				...
				<p>The password needs to contain between 7 and 8 characters of
					at least three of the following four categories: small letters ('a'
					- 'z'), capital letters ('A' - 'Z'), digits ('0' - '9') and any of
