			...
			<form method="POST" action="index.jsp">
				...
				out.print(request.getParameter("newGenre"));%>"
					...
					<tr>
						...
						<input type="hidden" name="action" value="langFilled">
						<input class="btn btn-primary1 btn-large" type="submit" value="Create Language"></td>
						<td></td>
					</tr>
				</table>
			</form>
