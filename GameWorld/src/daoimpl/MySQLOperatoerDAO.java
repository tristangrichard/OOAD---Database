...
public class MySQLOperatoerDAO implements IOperatoerDAO {
	...
	public BrugerDTO getOperatoer(int oprId) throws DALException {
	    ...
	    try {
	    	...
	    	return new BrugerDTO (rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6));
	    }
	    catch (SQLException e) {throw new DALException(e); }
		
	}
	
	public void createOperatoer(BrugerDTO opr) throws DALException {		
			Connector.doUpdate(
	...
	public void updateOperatoer(BrugerDTO opr) throws DALException {
		Connector.doUpdate(
	...
	public List<BrugerDTO> getOperatoerList() throws DALException {
		...
		try
		{
			while (rs.next()) 
			{
				list.add(new BrugerDTO(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6)));
			}
		}
		catch (SQLException e) { throw new DALException(e); }
		return list;
